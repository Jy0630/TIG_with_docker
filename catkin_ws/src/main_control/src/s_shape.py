...
if __name__ == '__main__':
    ...
    goals_with_params = [
        ...
        ((-4.0, -5.2, -1.0, 0.0), (0.5, -0.3, 0.8, -0.8, 32, 20, 0.2, 0.2)),
        ((-4.0, -2.5, -0.7, 0.72), (0.5, -0.3, 0.8, -0.8, 32, 20, 0.2, 0.2)),
        ((-2.53, -2.5, -1.0, 0.0), (0.5, -0.3, 0.8, -0.8, 32, 20, 0.2, 0.2)),
        ((-2.53, -5.2, 0.72, 0.69), (0.5, -0.3, 0.8, -0.8, 32, 20, 0.2, 0.2)),
        ((-0.35, -5.2, -1.0, 0.0), (0.5, -0.3, 0.8, -0.8, 32, 20, 0.2, 0.2))
    ]

    for goal, params in goals_with_params:
        # Update DWA parameters before sending the goal
        update_dwa_params(params[0], params[1], params[2], params[3], 
