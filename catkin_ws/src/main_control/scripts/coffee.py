...
#################################################################
            ...
            #         current_state = "ERROR_RECOVERY"
                ...
                if self.navigate_by_wall(front=1.015, angle=0.0, align_wall="front"):
                    current_state = "3"
                else:
                    current_state = "ERROR_RECOVERY"
...
#################################################################
                ...
                if self.call_set_distance(self.motor_num, 8.5):
                    current_state = "3.5"
                else:
                    current_state = "ERROR_RECOVERY"
...
#################################################################
                ...
                if self.call_set_distance(self.motor_num, 7.394):
                    current_state = "4.7"
                else:
                    current_state = "ERROR_RECOVERY"
...
##########################################################################                    
            # elif self.table == 1 and current_state == "5":
                ...
                if self.navigate_by_wall(right = 1.88, front = 1.182, angle=0.0, align_wall="right"):
                    current_state = "6.5"
                else:
                    current_state = "ERROR_RECOVERY"
...
# ##########################################################################                   
#             elif self.table == 2 and current_state == "5":
#                 if current_state == "5":
...
#                         current_state = "ERROR_RECOVERY"
# ##########################################################################                    
#             elif self.table == 3 and current_state == "5":
#                 if current_state == "5":
#                     if self.navigate_by_odometry(angle=170):
#                         current_state = "5.5"
#                     else:
...
# ##########################################################################                    
#             elif self.table == 4 and current_state == "5":
#                 if current_state == "5":
#                     if self.navigate_by_odometry(angle=170):
#                         current_state = "5.5"
#                     else:
