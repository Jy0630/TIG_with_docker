...
class MecanumController:
    ...
    def load_params(self):
        self.pixel_thresh_normal = rospy.get_param('~pixel_thresh_normal', 20) # Less than this is good
        self.pixel_thresh_large = rospy.get_param('~pixel_thresh_large', 120) # More than this is really bad
        self.angle_thresh_rotate = rospy.get_param('~angle_thresh_rotate', 25) # More than this is bad, need to rotate
        self.angle_thresh_ok = rospy.get_param('~angle_thresh_ok', 10) # Rotate until error is less than this
        ...
        self.lat_speed_correct_large = rospy.get_param('~lat_speed_correct_large', 0.055)
        self.rot_speed_correct = rospy.get_param('~rot_speed_correct', 0.15)
        rospy.loginfo("Control parameters loaded successfully.")
